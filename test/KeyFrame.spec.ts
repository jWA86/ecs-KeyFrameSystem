...
import { KeyFrameSystem, bezier } from "../src/KeyFrameSystem"
import { PlaybackState, IFrameEvent, IKeyFrame, IKeyFrameController, KeyFrameControllerComponent } from "../src/KeyFrameController";
    ...
    describe("cycling", () => {
        ...
        describe("looping in reverse", () => {
            ...
            it("should set playsate to ended when all loop completed then stopped", () => {
                ...
                let nbIncrement = c.nbLoop * c.duration + c.from + 1;
                let fps = 1000 / 60;
